...
public class AppList extends ExpandableListActivity
{
  ...
  /**
   * Creates the child list out of the shades[] array according to the structure
   * required by SimpleExpandableListAdapter. The resulting List contains one
   * list for each group. Each such second-level group contains Maps. Each such
   * Map contains two keys: "shadeName" is the name of the shade and "rgb" is
   * the RGB value for the shade.
   */
